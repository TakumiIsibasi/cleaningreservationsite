...
class User_contactus(models.Model):
    ...
    contactus_message = models.TextField(max_length=500, validators=[MaxLengthValidator(500)],verbose_name="メッセージ内容")
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="作成日時")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="更新日時")
   
    def __str__(self):
        return self.contactus_name#管理画面を作ってリスト表示されるときこれが表示される